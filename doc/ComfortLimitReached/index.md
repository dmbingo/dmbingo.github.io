...
description: "Причиной бросить проект стал дискомфорт испытываемый при переключении на свой проект от работы делаемой по найму. Казалось что это ведет к утере привычного ощущения безопасности при пересечении границы смены фокуса"
---
{% include footnote.md %}
<a href="/_cards/">![Предел комфорта](/_img/1.svg)</a>
